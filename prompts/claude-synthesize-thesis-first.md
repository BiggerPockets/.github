...
9. When the diff touches CI config, a GitHub Actions workflow, or any unattended job,
   review it per these rules:
...
10. Validate which of Codex's findings are real (discard false positives), add any genuine
   ...
   acceptance criteria in a sound way rather than flagging it as non-compliant. Hold every
   claim you make and every finding you retire to these rules:
